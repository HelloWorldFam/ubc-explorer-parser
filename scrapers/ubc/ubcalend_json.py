...
# use this to initialize dict if we need all fields present
# dictdata = {
#     "code": "",
#     "name": "",
#     "desc": "",
...
def translate(url, outjson):
    ...
    for byte in html:
        ...
        #  'br> ', 'em>Corequisite:', '/em> CPSC 110.', 'br> \n']
            ...
            dictlist.append(dictdata.copy())
            dictdata.clear()
    with open(outjson, 'w') as jsonout:
        jsonout.write(json.dumps(dictlist))
